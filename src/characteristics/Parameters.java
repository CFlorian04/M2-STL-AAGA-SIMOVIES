...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "MecaMouse";
  public static final String teamAMainBotBrainClassName = "algorithms.MecaMouseMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.MecaMouseSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.NeuroBotMain"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.NeuroBotSecondary"; //class given by name; is supposed to extends robotsimulator.Brain
