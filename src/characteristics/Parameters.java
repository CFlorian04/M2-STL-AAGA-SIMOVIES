...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.Stage8MainA"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.Stage8SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
