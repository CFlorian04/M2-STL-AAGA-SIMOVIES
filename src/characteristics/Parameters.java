...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.BrainTest1"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.BrainTest1"; //class given by name; is supposed to extends robotsimulator.Brain
